...
<body>
    <!-- Inline JavaScript -->
    <button onclick="alert('Korn Daengthong')">ปุ่มที่ 1</button>
...
```
[รูปผลการทดลองที่ 1]
![K01](https://github.com/user-attachments/assets/6a499b9e-2747-4e3e-85ba-84689005a054)
...
![K2 3 1](https://github.com/user-attachments/assets/995c3c8d-7127-4d4c-9317-69cb0243a8f2)
![K2 3 2](https://github.com/user-attachments/assets/1db75091-3054-4481-97b8-d8ec9354df7a)
![K2 3 3](https://github.com/user-attachments/assets/2903b509-4c33-44ce-a421-2137e1fa33bd)
![K2 3 4](https://github.com/user-attachments/assets/70cdf9fd-9154-44f4-be97-d46010d3c089)
![K2 3 5](https://github.com/user-attachments/assets/b95028fb-1de0-4108-8a1a-008d4ec18526)
    ...
    <script>
        ...
        const checkPasswordLength = () => {
            ...
            if (password.length === 8) {
                document.getElementById('passwordResult').innerText = '✅ เย่!รหัสผ่านถูกต้อง';
            } else {
...
![K2 4 2 1](https://github.com/user-attachments/assets/69593d61-5654-469f-b94d-e6e0edf42bbc)
...
![K3 1](https://github.com/user-attachments/assets/fbb27fc8-cb13-4832-aeb2-25b42ab03688)
...
![K3 1 1](https://github.com/user-attachments/assets/02703400-8dab-4a61-a53c-53d8fab5512e)
...
![K3 2](https://github.com/user-attachments/assets/394f0dd2-a8b8-4695-a0d6-321f45ab9818)
## คำแนะนำเพิ่มเติม
